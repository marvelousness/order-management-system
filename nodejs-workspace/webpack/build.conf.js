...
module.exports = WebpackMerge(require("./conf"), {
	...
	plugins: [
		...
		// 		to: resolve("target/statics/images")
		// 	}, {
		// 		from: resolve("src/assets/iconfont"),
		// 		to: resolve("target/statics/iconfont")
		// 	}]
		// }),
